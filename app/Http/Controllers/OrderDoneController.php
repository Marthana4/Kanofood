...
class OrderDoneController extends Controller
{
    ...
    public function index()
    {
        ...
        ->count();
        $orderdone= Order::select('order_menus.id_order as id_order','order_menus.total_order as total_order', 
        ...
        ->Where('order_status','done')
        ->paginate(10);
        return view('Admin.order_done',compact('orderdone','total_order','done_order','process_order','cancel_order'));
