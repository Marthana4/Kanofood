...
class OrderProcessController extends Controller
{
    ...
    public function index()
    {
        ...
        ->count();
        $orderprocess= Order::select('order_menus.id_order as id_order','order_menus.total_order as total_order', 
        ...
        return view('Admin.order_process',compact('orderprocess','total_order','done_order','process_order','cancel_order'));
